...
/**
 * Verifies UserService against every contract published for it in the Pact
...
class UserServiceProviderIT {
    ...
    @State("user 1 exists")
    void userExists() {
        // User data is hardcoded in the controller, so no fixture setup is needed.
    }
}
